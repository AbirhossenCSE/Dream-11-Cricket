    ...
    return (
        <div className="mt-36">
            <div className="bg-[#06091A] text-white">
                <div className='relative -top-28 bg-white w-8/12 mx-auto rounded-xl text-black border-2 p-8'>
                    <div className='bg2 w-full flex flex-col space-y-4 justify-center items-center'>
                        ...
                        <div className='p-4'>
                            <input className="rounded-xl p-2 border-2" type="text" placeholder="Enter Your Emai" />
                            <button className="bg-white text-black rounded-xl ml-1 p-2 border-2">Subscribe</button>
                        </div>
                    </div>
                </div>
                <div>
